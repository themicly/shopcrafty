...
[![Tests](https://img.shields.io/github/actions/workflow/status/themicly/shopcrafty/tests.yml?branch=main&label=tests&style=flat-square)](https://github.com/themicly/shopcrafty/actions/workflows/tests.yml)
